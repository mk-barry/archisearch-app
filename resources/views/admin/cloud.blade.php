<x-admin-layout active="cloud" title="Sauvegarde Cloud - ArchiSearch">
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-start; width: 100%; margin-top: 1.5rem;">
        
        <!-- Left: Configuration (30%) -->
        <div style="width: 30%; flex-shrink: 0; display: flex; flex-direction: column; gap: 1.5rem;">
            <!-- Backup Mode -->
            <div class="card" style="padding: 1.5rem;">
                <h3 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 1.25rem;">Mode de sauvegarde</h3>
                ...
                <div class="selection-card" onclick="selectCard(this)">
                    <input type="radio" name="backup_mode" style="display:none;">
                    <div class="icon-inner">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2v20"/><path d="m17 17-5 5-5-5"/><path d="m17 7-5-5-5 5"/></svg>
                    </div>
                    <div>
            ...
            <!-- Cloud Destination -->
            <div class="card" style="padding: 1.5rem;">
                <h3 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 1.25rem;">Destination cloud</h3>
                
                <div class="selection-card active" onclick="selectCard(this)">
                    <input type="radio" name="cloud_dest" checked>
                    <div>
                        <div style="font-weight: 700; color: #1e293b; font-size: 0.95rem;">Stockage local sécurisé (MinIO)</div>
            ...
            <button class="btn-primary" style="width: 100%; height: 50px; border-radius: 12px; font-weight: 700; display: flex; align-items: center; justify-content: center; gap: 10px;">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17.5 19A5.5 5.5 0 0 0 18 8.02a1 1 0 0 1-.89-.66 7 7 0 0 0-12.22 0 1 1 0 0 1-.89.66A5.5 5.5 0 0 0 4.5 19Z"/><path d="M12 12v9"/><path d="m15 18-3 3-3-3"/></svg>
        ...
        <div style="width: 65%; flex-shrink: 0; display: flex; flex-direction: column; gap: 1.5rem;">
            ...
            <!-- Activity Chart -->
            <div class="card" style="padding: 1.5rem;">
                <h3 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 2rem;">Activité de sauvegarde — 7 derniers jours</h3>
                <div style="height: 250px; background: #fafafa; border: 1px dashed #e2e8f0; border-radius: 10px; display: flex; align-items: center; justify-content: center; color: #94a3b8; font-size: 0.9rem;">
                    [ Espace réservé pour le graphique d'activité ]
                </div>
            </div>

            <!-- Status Table -->
            <div class="card" style="padding: 1.5rem;">
                <h3 style="font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 1.5rem;">Dernière sauvegarde — Statut par document</h3>
                <table style="width: 100%; border-collapse: collapse;">
                    <thead>
                        <tr style="text-align: left; border-bottom: 1px solid #f1f5f9;">
                            <th style="padding: 1rem 0; font-size: 0.75rem; color: #94a3b8; text-transform: uppercase;">DOCUMENT</th>
                            <th style="padding: 1rem 0; font-size: 0.75rem; color: #94a3b8; text-transform: uppercase;">CATÉGORIE</th>
                            <th style="padding: 1rem 0; font-size: 0.75rem; color: #94a3b8; text-transform: uppercase;">STATUT</th>
                            <th style="padding: 1rem 0; font-size: 0.75rem; color: #94a3b8; text-transform: uppercase;">DERNIÈRE TENTATIVE</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td style="padding: 1.25rem 0; font-weight: 600; color: #475569;">Contrat_Dupont_2026.pdf</td>
