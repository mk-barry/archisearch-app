...
<div class="results-list">
    ...
    @foreach($results as $doc)
        ...
        <div class="result-card">
            ...
            <div class="file-icon-box bg-jpg">
            ...
            <div class="right" style="display: flex; flex-direction: column; justify-content: space-between; align-items: center;">
                <span class="badge" style="padding: 2px 8px; border-radius: 12px; font-size: 0.7rem; text-transform: uppercase; background: #f1f5f9;">
                {{ $doc->status }}
            </span>
            <div class="meta-item">
