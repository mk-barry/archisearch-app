@push('styles')
    <link rel="stylesheet" href="{{ asset('css/super-admin/settings.css') }}">
@endpush
...
<x-dashboard-layout active="parametres">
                    ...
                    <div style="flex: 1;">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div style="display: flex; align-items: center; gap: 12px;">
                                ...
                                <button class="action-btn"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"/></svg></button>
                            </div>
                        </div>
                        <div class="tag-list">
        ...
        <div style="display: flex; flex-direction: column; gap: 1.5rem;">
            ...
            <div class="dashboard-card">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <a href="#" style="font-size: 0.8rem; color: #2563eb; font-weight: 600; text-decoration: none;">Modifier</a>
                </div>
            ...
            <div class="dashboard-card">
                ...
                <div class="settings-row-item">
                    <div>
                        ...
                        <div style="font-size: 0.75rem; color: #94a3b8; font-family: monospace;">ÉVÉNEMENT_DATE_NOM</div>
                    </div>
    ...
    <!-- Bottom Actions -->
    <div style="position: fixed; bottom: 0; right: 0; left: 260px; padding: 1.5rem 2rem; background: white; border-top: 1px solid #f1f5f9; display: flex; justify-content: flex-end; gap: 1rem; z-index: 80;">
