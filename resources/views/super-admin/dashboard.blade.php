    ...
    <x-slot:title>Supervision - ArchiSearch</x-slot>
        ...
        <div class="page-header">
            ...
            <div class="admin-info">
                <div class="avatar" style="width: 40px; height: 40px; font-size: 0.8rem; background: #e0f2fe; color: #0369a1; display: flex; align-items: center; justify-content: center; border-radius: 50%; overflow: hidden;">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div style="margin-top: 0.75rem;"><span class="trend up">↑ stable</span> <span
            ...
            <div class="stat-card">
                ...
                <div style="margin-top: 0.75rem;"><span
                        ...
                        @foreach($eventStats as $label => $val)
                            <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                <div style="display: flex; align-items: center; gap: 8px;">
                                    <div
                                        style="width: 10px; height: 10px; border-radius: 2px; background: {{ $loop->first ? '#2563eb' : ($loop->iteration == 2 ? '#10b981' : '#64748b') }};">
                                    </div>
                                    {{ ucfirst($label) }}
                                </div>
                                <strong>{{ $val }}</strong>
            ...
            <div class="dashboard-card">
                <div class="card-title">
                    ...
                    <a href="{{ route('super-admin.logs') }}"
                        style="font-size: 0.8rem; font-weight: 500; color: #2563eb; text-decoration: none;">Voir tous
                        les journaux</a>
                </div>
